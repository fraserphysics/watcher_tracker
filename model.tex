...
\end{align}
one can write recursive filtering as follows:
\begin{align}
...
\begin{align*}
  ...
  & \quad \ti{\hat s}{t} = M_t( \ti{\hat s}{t+1})
\end{align*}
