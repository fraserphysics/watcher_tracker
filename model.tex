...
\item[Calculate the inverse covariance of the forecast observation:]
  \begin{equation*}
   ...
   \Sigma_O^{-1}
  \end{equation*}
\item[Calculate the Kalman gain matrix $K$:]
  \begin{equation*}
...
determine the best predecessor permutations, I drop the term $\logdet$
from Eqn.~\eqref{eq:new_R} because they are independent of both $M$
and $s$.
