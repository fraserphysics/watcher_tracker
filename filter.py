"""
filter.py code for doing filtering and tracking

"""
import numpy, scipy, scipy.linalg, random
...
class model1:
    ...
    def simulate(self, xp):
        ...
        both
        """
        xn = self.F*xp + normal(xp*0,self.Sigma_D)
        y = self.G*xn
        zero = y*0
        yn = y + normal(zero,self.Sigma_O)
        return yn,xn
